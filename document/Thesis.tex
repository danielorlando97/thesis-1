...
\floatstyle{plaintop}
\restylefloat{table}
\usepackage[backend=biber,style=numeric,sortcites,sorting=nty,backref, hyperref, natbib]{biblatex}
...
\title{DSL en Python, Descripción de Espacios de Búsquedas Y Generación Muestras}
\author{\\\vspace{0.25cm}Daniel Orlando Ortiz Pacheco}
\advisor{\\\vspace{0.25cm}Lic. Frank Sadan Naranjo\\\vspace{0.2cm}Doc. Alejandro Piad Morffis}
